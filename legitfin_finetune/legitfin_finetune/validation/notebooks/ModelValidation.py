...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``legitfin_finetune/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in legitfin_finetune/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in legitfin_finetune/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-legitfin_finetune-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.legitfin.legitfin_finetune-model", "Full (Three-Level) Model Name")
