...
# ``legitfin_finetune/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-legitfin_finetune-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.legitfin.legitfin_finetune-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.legitfin.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.legitfin.trip_dropoff_features",
